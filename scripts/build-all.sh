...
echo ""
echo -e "${BOLD} Zinc — Building native components (shared memory core)${NC}"
...
echo ""
echo "  Usage (shared buffer):"
echo "    import { sharedBuffer } from './src/index.ts'"
echo "    const region = await sharedBuffer('/my-data', 1024 * 1024, true)"
echo ""
echo "  Legacy RPC demo:"
